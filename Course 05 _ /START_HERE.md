...
**Don't jump ahead to Unit 2!** You'll be confused without the foundation knowledge.
...
4. ✅ Open `unit1-introduction/examples/01_data_science_intro.py` (or `.ipynb`) and start learning!
...
**Next action:** Open `unit1-introduction/examples/01_data_science_intro.py` (or `.ipynb`) and begin your data science journey!
